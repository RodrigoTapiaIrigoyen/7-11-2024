...
const HomePage = () => {
  const games = [
    ...
    },
    {
      ...
      description:
        'The legendary fighting game series returns with new mechanics',
    },
    {
    ...
    },
    {
      ...
      description:
        'Soccer meets driving in this award-winning competitive game',
    },
  ];
              ...
              <div className="relative pt-[56.25%]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
                    ...
                    <Link to="/1vs1" className="btn-primary inline-block">
                      Play Now
                    </Link>
                  </div>
                </div>
  ...
  return (
    <Link to={link} className="block">
      <div className="glass-effect rounded-lg p-6 hover:bg-white/10 transition-all duration-300 transform hover:scale-105 hover:shadow-xl group">
        <div className="text-game-accent mb-4 group-hover:animate-bounce">
          {icon}
        </div>
        <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-gradient">
          {title}
        </h3>
